function [ model, In ] = runNLSA_den_ose( experiment, iProc, nProc, ifPlot )
%
...
% l63NLSAModel_den are changed, it is only necessary to repeat the steps 
...
disp( experiment )
[ model, In ] = noaaNLSAModel_den_ose( experiment ); 
