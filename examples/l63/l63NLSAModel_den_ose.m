...
switch experiment
    ...
    case 'test'
        ...
        In.idxX   = 1 : 3;     % state vector observed components
    ...
    case '64k'
        ...
        In.rho    = 28;    % L63 parameter rho
        In.sigma  = 10;    % L63 parameter sigma
        In.idxX   = 1 : 3; % observed state vector components
        In.nSProd = 64000; % number of "production samples
        In.nSSpin = 64000; % spinup samples
        In.nEL    = 0;     % embedding window length (additional samples)
        In.nXB    = 1;     % additional samples before production interval (for FD)
        In.nXA    = 500;     % additional samples after production interval (for FD)
        In.dt     = 0.01;  % sampling interval
        In.x0     = [ 0 1 1.05 ]; % initial conditions
        In.relTol = 1E-8;  % relative tolerance for ODE solver 
        In.ifCent = false; % data centering
        ...
        Out.nSSpin = 128000; % spinup samples
        Out.nEL    = 0;     % embedding window length (additional samples)
        Out.nXB    = 1;     % additional samples before production interval (for FD)
        Out.nXA    = 500;     % additional samples after production interval (for FD)
        Out.dt     = 0.01;  % sampling interval
        Out.x0     = [ 0 1 1.05 ]; % initial conditions
        Out.relTol = 1E-8;  % relative tolerance for ODE solver 
        Out.ifCent = false; % data centering
        ...
        In.denAlpha    = 0;             % cone kernel velocity exponent (for KDE)
        In.denEpsilonB = 2;             % kernel bandwidth base (for KDE)
        In.denEpsilonE = [ -20 20 ];    % kernel bandwidth exponents (for KDE)
        In.denNEpsilon = 200;           % number of exponents for bandwidth tuning

        % NLSA parameters, out-of-sample data
        Out.nB           = 4;         % bathches to partition the in-sample data
        Out.nBRec        = Out.nB;    % batches for reconstructed data
        Out.nN           = In.nN;     % nearest neighbors for pairwise distances
        Out.lDist        = In.lDist;  % local distance
        Out.tol          = 0;         % 0 distance threshold (for cone kernel)
...
% 6400 samples, standard L63 parameters
    case '6.4k'
        ...
        In.sigma  = 10;    % L63 parameter sigma
        In.idxX   = 1 : 3; % observed state vector components
        In.nSProd = 6400;  % number of "production samples
        In.nSSpin = 64000; % spinup samples
        In.nEL    = 0;     % embedding window length (additional samples)
        In.nXB    = 1;     % additional samples before production interval (for FD)
        In.nXA    = 500;     % additional samples after production interval (for FD)
...
case '6.4k_dt0.1'
        ...
        In.nEL    = 0;     % embedding window length (additional samples)
        In.nXB    = 1;     % additional samples before production interval (for FD)
        In.nXA    = 50;     % additional samples after production interval (for FD)
        In.dt     = 0.1;  % sampling interval
        In.x0     = [ 0 1 1.05 ]; % initial conditions
        In.relTol = 1E-8;  % relative tolerance for ODE solver 
        In.ifCent = false; % data centering
        In. nS     =   In.nSProd + In.nEL + In.nXB + In.nXA; % sample number
        ...
        Out.nEL    = 0;     % embedding window length (additional samples)
        Out.nXB    = 1;     % additional samples before production interval (for FD)
        Out.nXA    = 50;     % additional samples after production interval (for FD)
        Out.dt     = 0.1;  % sampling interval
        Out.x0     = [ 0 1 1.05 ]; % initial conditions
        Out.relTol = 1E-8;  % relative tolerance for ODE solver 
        Out.ifCent = false; % data centering
        Out. nS     =   Out.nSProd + Out.nEL + Out.nXB + Out.nXA; % sample number
    ...
    % 64000 samples, standard L63 parameters, partial obs
    case '64k_1'
        % In-sample dataset parameters
        In.beta   = 8/3;   % L63 parameter beta
        In.rho    = 28;    % L63 parameter rho
        In.sigma  = 10;    % L63 parameter sigma
        In.idxX   = 1; % observed state vector components
        In.nSProd = 64000; % number of "production samples
        In.nSSpin = 64000; % spinup samples
        In.nEL    = 0;     % embedding window length (additional samples)
        In.nXB    = 1;     % additional samples before production interval (for FD)
    ...
    case '64k_12'
        ...
        In.rho    = 28;    % L63 parameter rho
        In.sigma  = 10;    % L63 parameter sigma
        In.idxX   = [ 1 2 ]; % observed state vector components
        In.nSProd = 64000; % number of "production samples
        In.nSSpin = 64000; % spinup samples
        In.nEL    = 0;     % embedding window length (additional samples)
        In.nXB    = 1;     % additional samples before production interval (for FD)
    ...
    % 64000 samples, standard L63 parameters, partial obs, delays
    case '64k_1_q7'
        % In-sample dataset parameters
        In.beta   = 8/3;   % L63 parameter beta
        In.rho    = 28;    % L63 parameter rho
        ...
        In.nSProd = 64000; % number of "production samples
        In.nSSpin = 64000; % spinup samples
        In.nEL    = 7;     % embedding window length (additional samples)
        In.nXB    = 1;     % additional samples before production interval (for FD)
        In.nXA    = 500;     % additional samples after production interval (for FD)
        In.dt     = 0.01;  % sampling interval
        In.x0     = [ 0 1 1.05 ]; % initial conditions
        ...
        Out.nSProd = 64000; % number of "production samples
        Out.nSSpin = 128000; % spinup samples
        Out.nEL    = 7;     % embedding window length (additional samples)
        Out.nXB    = 1;     % additional samples before production interval (for FD)
        Out.nXA    = 500;     % additional samples after production interval (for FD)
        Out.dt     = 0.01;  % sampling interval
        Out.x0     = [ 0 1 1.05 ]; % initial conditions
    ...
    case '64k_1_q15'
        ...
        In.nSProd = 64000; % number of "production samples
        In.nSSpin = 64000; % spinup samples
        In.nEL    = 15;     % embedding window length (additional samples)
        In.nXB    = 1;     % additional samples before production interval (for FD)
        In.nXA    = 500;     % additional samples after production interval (for FD)
        In.dt     = 0.01;  % sampling interval
        In.x0     = [ 0 1 1.05 ]; % initial conditions
        ...
        Out.nSProd = 64000; % number of "production samples
        Out.nSSpin = 128000; % spinup samples
        Out.nEL    = In.nEL; % embedding window length (additional samples)
        Out.nXB    = 1;     % additional samples before production interval (for FD)
        Out.nXA    = 500;     % additional samples after production interval (for FD)
        Out.dt     = 0.01;  % sampling interval
        Out.x0     = [ 0 1 1.05 ]; % initial conditions
    ...
    case '64k_1_q24'
        ...
        In.nSProd = 64000; % number of "production samples
        In.nSSpin = 64000; % spinup samples
        In.nEL    = 24;     % embedding window length (additional samples)
        In.nXB    = 1;     % additional samples before production interval (for FD)
        In.nXA    = 500;     % additional samples after production interval (for FD)
        In.dt     = 0.01;  % sampling interval
        In.x0     = [ 0 1 1.05 ]; % initial conditions
...
if numel( In.idxX ) == 3 && all( In.idxX == [ 1 2 3 ] )
    idxInfix = '';
else
...
tagSrc   = strcat( strSrc, idxInfix );          % tag for in-sample data
tagOut   = strcat( strOut, idxInfix );          % tag for out-of-sample data
