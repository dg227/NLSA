...
idxPhi      = 1 : 11;     % hypothesis space basis functions 
idxPhiVar   = 1 : 11;     % basis functions for conditional variance 
...
%tNum0Plt    = '199707';   % initialization time to plot forecast
