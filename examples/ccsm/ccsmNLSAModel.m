function [ model, In ] = ccsmNLSAModel( experiment )
%% CCSMNLSAMODEL Build NLSA model for  monthly data from the CCSM/CESM
%  climate models. 
% 
...
switch experiment
    ...
    case 'np_sst'
        ...
        In.Trg( 1 ).field      = 'SST';       % field for target component 1
