function [ model, In, Out ] = climateNLSAModel_den_ose( experiment )
%% CLIMATENLSAMODEL_DEN_OSE NLSA model with kernel density estimation and out-of-sample extension (OSE) for climate datasets
% 
...
switch experiment
    ...
    case 'ip_sst'
        ...
        In.Res( 1 ).experiment = 'hadisst';      % HadISST dataset
        % Indo-Pacific SST
        ...
        %Out.Res( 1 ).tLim      = { '198801' '201902' }; % time limits (years)
    ...
    case 'ip_sst_operational'
        ...
        In.tFormat             = 'yyyymm';    % time format
        In.freq                = 'monthly'; % sampling frequency
        In.Res( 1 ).tLim       = { '187001' '201412' }; % time limit  
        ...
        % Out-of-sample dataset parameters
        Out.Res( 1 ).tLim       = { '201501' '201902' }; % time limits (years)
    ...
    case 'ip_sst_nino'
        ...
        In.Trg( 1 ).yLim       = [ -5 5 ]; % latitude limits
        % Nino 1+2 index
        In.Trg( 2 ).field      = 'sstawav_198101-201012';      % physical field
        In.Trg( 2 ).xLim       = [ 270 280 ];  % longitude limits
        In.Trg( 2 ).yLim       = [ -10 0 ]; % latitude limits
        % Nino 3 index
        In.Trg( 3 ).field      = 'sstawav_198101-201012';      % physical field
        In.Trg( 3 ).xLim       = [ 210 270 ];  % longitude limits
        In.Trg( 3 ).yLim       = [ -5 5 ]; % latitude limits
        % Nino 4 index
        In.Trg( 4 ).field      = 'sstawav_198101-201012';      % physical field
        In.Trg( 4 ).xLim       = [ 160 210 ];  % longitude limits
