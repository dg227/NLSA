function ensoQMDA_test_data( dataset, period, fld )
% ENSOQMDA_TEST_DATA Helper function to import out-of-sample (test)  datasets 
% for quantum mechanical data assimilation of ENSO.
%
...
case 'ersstV4'
    ...
    case '10yr'
        ...
        DataSpecs.Time.tLim    = { '200801' '202002' }; % time limits
