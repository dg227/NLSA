...
xLim       = [  0 359 ];          % longitude limits
yLim       = [ -30  20 ];          % latitude limits
yLim       = [ -50  50 ];          % latitude limits
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Nino 3.4 region
%xLim = [ 190 240 ];                 % longitude limits 
%yLim = [ -5 5 ];                    % latitude limits
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
tLim       = { '187001' '199712' }; % training time limits 
%tLim       = { '199701' '201712' }; % verification time limits 
