...
%
%  climateNLSAModel_base uses the parameter values in In and Out to create
%  arrays of nlsaComponent objects representing the in-sample and out-of-
%  sample data, respectively. Then, it passses these arrays along with the
%  parameter values to function /utils/nlsaModelFromPars, which prepares
