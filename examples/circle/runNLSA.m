...
% for data generated by the dynamical system on the circle in circleData.m  
%
...
% circleNLSAModel, it is only necessary to repeat the steps that are
...
disp( experiment )
[ model, In ] = circleNLSAModel( experiment ); 
