...
% executes the various NLSA steps for CLAUS brightness temperature data.
%
...
% clausNLSAModel_den are changed, it is only necessary to repeat the steps 
...
%               the function clausNLSAModel_den
%
...
disp( experiment )
[ model, In ] = clausNLSAModel_den( experiment ); 
