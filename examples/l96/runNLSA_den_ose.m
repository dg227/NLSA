...
% out-of-sample extension (OSE), and executes the various NLSA steps for data 
% generated by the Lorenz 96 system. 
%
...
% ll96NLSAModel_den are changed, it is only necessary to repeat the steps 
...
%               the function ll96NLSAModel_den
%
...
disp( experiment )
[ model, In ] = l96NLSAModel_den_ose( experiment ); 
