...
%  data generated by the Lorenz 96 system
%
...
% l96NLSAModel are changed, it is only necessary to repeat the steps 
...
disp( experiment )
[ model, In ] = l96NLSAModel( experiment ); 
