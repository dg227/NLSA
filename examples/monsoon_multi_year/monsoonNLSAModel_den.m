...
switch experiment
    ...
    case 'std'
        ...
        In.denZeta      = 0;
        In.denIfVNorm   = false;
        In.denDistNorm     = 'geometric'; % kernel normalization (geometric/harmonic)
...
dateStrShort = [ sprintf( '%i-%i', In.yrLim ) '_' strjoin( In.dateLim, '-' ) ];
...
denPDist = nlsaPairwiseDistance( 'nearestNeighbors', In.nN, ...
                                 'localDistance', denLDist );

den = nlsaKernelDensity_vb( 'dimension', In.denND, ...
                            'kNN',       In.denNN );

lDist = nlsaLocalDistance_l2_den( 'mode', 'implicit', ...
                                  'beta', In.denBeta );
...
pDist = nlsaPairwiseDistance_den( 'nearestNeighbors', In.nN, ...
                                  'localDistance', lDist );
...
model = nlsaModel_den( 'path',                            nlsaPath, ...
                       ...
                       'sourceRealizationName',           dateStrShort, ... 
                       'densityRealizationName',          dateStrShort, ... 
