function computeDensityDelayEmbeddingQ( obj, iProcC, nProcC )
% COMPUTEDENSITYDELAYEMBEDDINGQ Lag-embed the kernel density data in an 
% nlsaModel_den object using the query partition
%
% Modified 2019/11/24
