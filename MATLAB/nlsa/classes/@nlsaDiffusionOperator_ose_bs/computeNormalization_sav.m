function d = computeDegree( obj, dist, diffOp, varargin )
% COMPUTENORMALIZATION Compute kernel degree from in-sample distance data dist. diffOp is the in-sample diffusion operator.
% 
% Modified 2018/06/14
