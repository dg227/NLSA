...
res        = .5;                            % resolution
%tLim       = { '1984010100' '2006063021' }; % time limits 
tLim       = { '1984010100' '1984033021' }; % time limits 
nDX        = 2;                             % downsampling in x direction
nDY        = 2;                             % downsampling in y direction
nDT        = 2; %2                             % downsampling in time
