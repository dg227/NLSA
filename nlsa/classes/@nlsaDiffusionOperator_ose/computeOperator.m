...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Read the normalization and degree vectors for the in-sample data
if alpha ~= 0
    tic
...
for iBG = Opt.batch
    ...
    % Normalize by normalization vector
    if alpha ~= 0
        tic
    ...
    % Normalize by degree vector
    tic
    % Read out-of-sample degree vector
    dO = sqrt( getDegree( obj, iB, iR ) );
