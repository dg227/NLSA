function [ zeta, mu, gamma ] = getLeftEigenfunctions( obj, iB, iR, idxZeta, ...
                                                      varargin )
% GETLEFTEIGENFUNCTIONS  Read left eigenfunction data of an nlsaKoopmanOperator 
% object
%
% Modified 2020/08/27
...
file = fullfile( getEigenfunctionPath( obj ), getLeftEigenfunctionFile( obj ) );
load( file, varNames{ : } )
