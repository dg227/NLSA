...
This is a modified version of module jaxopt._src.linear_solve from the  JAXopt
library that treats functions of complex arguments as holomorphic functions.
"""
...
def _materialize_array(matvec, shape, dtype=None):
  ...
  Modified from the original version to set holomorphic=True in jacfxd.
  """
  x = jnp.zeros(shape, dtype)
  return jax.jacfwd(matvec, holomorphic=True)(x)
