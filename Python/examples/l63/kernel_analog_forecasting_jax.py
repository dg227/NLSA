...
jvmap: Callable[[F[Array, Array]], F[Array, Array]] = compose(jax.jit, vmap)
...
train_data_pars = DataPars(**common_pars, x0=(1, 1, 1.1), num_samples=4096)
test_data_pars = DataPars(
    **common_pars, x0=(1, 1, 0.9), num_samples=2048, batch_size=None
)
...
pred_pars = PredPars(
    dt=common_pars["dt"], num_steps=num_pred_steps, which_eigs=500
)
